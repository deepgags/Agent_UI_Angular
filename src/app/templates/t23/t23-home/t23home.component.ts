...
@Component({
	...
	templateUrl: "./t23-home.component.html",
	styleUrls: ["./t23-home.component.scss", "../t23.component.scss"],
	providers: [Title, StorageService],
})
export class T23HomeComponent implements OnInit {
